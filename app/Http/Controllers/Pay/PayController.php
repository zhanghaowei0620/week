...
//        $this->notify_url = env('ALIPAY_NOTIFY_URL');
        $this->return_url = env('ALIRETURN');
        $this->rsaPrivateKeyFilePath = storage_path('alipay/pay_private.pem');    //应用私钥
        $this->aliPubKey = storage_path('alipay/pay_public.pem'); //支付宝公钥
    }
    ...
    public function pay()
    {
        ...
        $order_info = OrderModel::where(['order_id'=>$oid])->first()->toArray();
